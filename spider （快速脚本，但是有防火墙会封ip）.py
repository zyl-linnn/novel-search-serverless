...
def parse_args():
    ...
    parser.add_argument('--workers', type=int, default=MAX_WORKERS, help='并发分类数，默认已是极速模式')
...
def main():
    ...
    # 使用命令行参数覆盖默认值
    global MAX_WORKERS, REQUEST_TIMEOUT, RETRY_TIMES, RETRY_503_WAIT
    ...
    # 并发上限不超过分类数；直接运行 python spider.py 即用最快默认策略
